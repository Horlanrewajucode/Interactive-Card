  ...
  return (
    <>
      <div className="flex items-center">
        <div className="md:bg-[url('/bg-main-desktop.png')] lg:bg-[url('/bg-main-desktop.png')] bg-no-repeat h-[100%] w-full bg-contain bg-[url('/bg-main-mobile.png')]">
...
function FrontCard({ formData }) {
  return (
    <div className="bg-[url('/bg-card-front.png')] md:bg-[url('/bg-card-front.png')] lg:bg-[url('/bg-card-front.png')] md:h-screen md:w-full lg:h-screen lg:w-full bg-no-repeat h-screen w-full relative top-40 left-60">
...
function BackCard({ formData }) {
  return (
    <div className="bg-[url('/bg-card-back.png')] md:bg-[url('/bg-card-back.png')] lg:bg-[url('/bg-card-back.png')] md:h-screen lg:h-screen lg:w-full md:w-full bg-no-repeat w-full h-screen absolute top-110 left-80">
